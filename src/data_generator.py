"""
Generate sample data for market-access-dashboard.
...
COLUMNS = ["product", "market", "formulary_coverage_pct", "reimbursed_pct", "unrestricted_access_pct", "time_to_access_days", "period"]
